...
export default function RegisterScreen({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      if (role === 'Pharmacist') {
        userData.specialty = specialty || 'General Pharmacist';
        userData.branch = branch?.toLowerCase() || 'limpopo';
        userData.verified = false;
        userData.license = null;
      }
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View style={styles.roleContainer}>
            ...
            <TouchableOpacity onPress={() => setRole('Pharmacist')} style={[styles.roleButton, role === 'Pharmacist' && styles.roleButtonActive]}>
              <Ionicons name="medkit-outline" size={24} color={role === 'Pharmacist' ? '#fff' : COLORS.primary} />
            ...
            <>
              ...
              {medicalAid && (
                <>
                  ...
                  <View style={styles.inputContainer}>
                    <Ionicons name="barcode-outline" size={20} color={COLORS.lightGray} style={styles.inputIcon} />
              ...
              <Text style={styles.label}>Extras (Allergies / Conditions)</Text>
              <View style={styles.inputContainer}>
                <Ionicons name="clipboard-outline" size={20} color={COLORS.lightGray} style={styles.inputIcon} />
                <TextInput placeholder="Enter extras" value={extras} onChangeText={setExtras} style={styles.input} placeholderTextColor={COLORS.lightGray} />
              </View>
            </>
          )}
